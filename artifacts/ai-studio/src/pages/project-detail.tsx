                  ...
                  <div className="relative z-10 flex flex-col items-center gap-5 text-center max-w-sm mx-auto px-6">
                    ...
                    <div className="flex flex-col gap-2 w-full">
                      ...
                      <p className="text-[10px] text-muted-foreground/50 font-mono">
                        Starter · Pro · Elite — 50% OFF flash promo (72h)
                      </p>
                    </div>
...
function AgentTerminal({
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden bg-[#06060f]">
      ...
      {/* Quick actions — collapsed by default, expand via button */}
      <div className="shrink-0 border-b border-border/40 bg-secondary/10">
        <details className="group">
          <summary className="list-none cursor-pointer select-none px-3 py-2 flex items-center justify-between hover:bg-secondary/20 transition-colors">
            <span className="text-[11px] font-mono text-muted-foreground uppercase tracking-widest flex items-center gap-1.5">
              {isGame
                ? <><Gamepad2 className="w-3 h-3 text-primary" /> Quick Actions</>
                : <><Sparkles className="w-3 h-3 text-primary" /> Quick Actions</>
              }
              <span className="text-[9px] text-muted-foreground/50 normal-case tracking-normal ml-1">
                ({(isGame ? GAME_QUICK_ACTIONS.length + QUICK_ACTIONS.length : QUICK_ACTIONS.length)})
              </span>
            </span>
          ...
          <div className="px-3 pb-3 pt-1">
            ...
            {isGame && (
              <div className="mt-2 pt-2 border-t border-border/30">
                <p className="text-[9px] text-muted-foreground/50 font-mono uppercase tracking-widest mb-1.5">General Actions</p>
                <div className="flex flex-wrap gap-1.5">
